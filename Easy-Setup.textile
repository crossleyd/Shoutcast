!http://beta.wavepanel.net/other/logos/11475_g9f4nsw2maqukubr22m4.jpeg!# jQuery-SHOUTcast Easy Setup
...
<body><!--Wavestreaming.com SHOUTcast Flash Player-->
<script type="text/javascript" src="http://player.wavestreamer.com/cgi-bin/swf.js?id=QJYZPAKKCV3Y0FSW"></script>
<script type="text/javascript" src=" http://player.wavestreaming.com/?id=QJYZPAKKCV3Y0FSW"></script>
<!--End Player-->
	...
	<script src="jquery.shoutcast.easy.min.js?host=example.com&port=8000"></script>
               ...
               <div class="togglerWrapper">
                  <div class="desc">
                     <h4>StreamFinder</h4>
                     <p>List on the Streamfinder directory?</p>
                  </div>
                  <div class="toggler">
                     <label for="allowStreamfinder" class="iToggle"></label>
                     <input type="checkbox" class="iToggle" name="allowstreamfinder" id="allowStreamfinder"/>
                  </div>
               </div>
               -->
